  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-6 font-sans xl:max-w-[2000px] 2xl:max-w-[2400px] lg:flex-row lg:gap-8 xl:gap-10">
      ...
      <aside
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(255,107,0,0.02), rgba(255,107,0,0.05))",
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <p className="text-[#ccc] text-[16px] text-center">
          ...
          >
            ...
            <span className="text-[#22c55e] font-bold text-[14px]">
              {candidate.validationStatus === "Valid Certificate"
                ? "Verified"
        ...
        <div className="flex flex-col gap-4 mb-8">
          <InfoRow
            ...
            value={`CD2025-INT-000${candidate.id}`}
        ...
        {/* Tech Stack */}
        <div>
          <p className="text-[#888] text-[12px] uppercase tracking-[1px] mb-3">
            Tech Stack
          </p>
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <Section>
          ...
          <div className="flex gap-8 mt-4">
            <div className="relative flex flex-col items-center">
              <div
                className="w-6 h-6 rounded-full border-2 border-[#0b0b0b] shrink-0"
                style={{
                  background: "#ff6b00",
              ...
              />
              <div
                className="w-0.5 flex-1 min-h-12.5"
                style={{
                  background: "linear-gradient(to bottom, #ff6b00, #22c55e)",
                }}
              />
              <div
                className="w-6 h-6 rounded-full border-2 border-[#0b0b0b] shrink-0"
            ...
            <div className="ml-auto text-right">
              ...
              <p className="text-[#ff6b00] font-bold text-[36px] leading-tight">
        ...
        <Section>
          ...
          <SectionHeader
            icon={BsBriefcase}
            title={
              activeTab === "projects" ? "Featured Projects" : "Weekly Projects"
            }
            iconColor="text-[#ff6b00]"
          />
          ...
          <div className="flex flex-col gap-4 mt-4">
              ...
              candidate.projects.map((project) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-[#aaa] text-[14px] mb-3">
                      {project.desc}
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className="w-10 h-10 rounded-xl border border-[rgba(255,107,0,0.3)] flex items-center justify-center"
                  >
            ...
            {activeTab === "weekly" &&
              candidate.weeklyProjects.map((item, index) => (
                <div
                  key={index}
                  className="rounded-xl border border-[rgba(255,255,255,0.1)] p-4 flex justify-between"
                  style={{ background: "rgba(255,255,255,0.03)" }}
                >
                  <span className="text-[#888]">Week {item.week}</span>
        ...
        <Section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            ...
            <StatCard label="Attendance">
              <p className="text-[#22c55e] font-bold text-[32px] text-center mt-1">
...
function StatCard({ label, children }) {
  return (
    <div
      ...
      style={{ background: "rgba(255,255,255,0.03)" }}
    >
      <p className="text-[#888] text-[12px] uppercase tracking-[1px] text-center">
        {label}
      </p>
      {children}
    </div>
